        ...
        <>
            <style>{`
                ...
                .team-image-wrapper {
                    ...
                    overflow: hidden;
                    margin: 0 auto 20px;
                    border: 4px solid rgba(0, 82, 157, 0.15);
                }
                ...
                .team-social-link.blue {
                    background: rgba(0, 82, 157, 0.1);
                    color: var(--dark-blue);
                }

                .team-social-link.maroon {
                    background: rgba(139, 35, 70, 0.1);
                    color: var(--maroon);
                }
                ...
                <section className="team-section">
                    <div className="container">
                        <div className="section-header-center">
                            ...
                            <h2 className="section-title center">Meet the People Behind Edufolio</h2>
                            <p className="section-subtitle center">
                            ...
                            {team.map((member, index) => (
                                <div key={index} className="team-card">
                                    ...
                                    <div className="team-social">
                                        <a href="#" className="team-social-link blue">
                                            <i className="fa-brands fa-linkedin-in"></i>
                                        </a>
                                        <a href="#" className="team-social-link maroon">
