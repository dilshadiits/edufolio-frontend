                ...
                <div className="ct-hero-container">
                    ...
                    <div className="ct-hero-content">
                        ...
                        <div className="ct-hero-quick-contact">
                            <a href="tel:+919876543210" className="ct-hero-quick-item">
                                ...
                                <div className="ct-hero-quick-text">
                                    ...
                                    <span className="ct-hero-quick-value">+91 98765 43210</span>
                                </div>
                            </a>
                            <a href="mailto:info@edufolio.com" className="ct-hero-quick-item">
                                <div className="ct-hero-quick-icon ct-hero-quick-icon-secondary">
                                    <i className="fa-solid fa-envelope" aria-hidden="true"></i>
                                </div>
                                <div className="ct-hero-quick-text">
                                    <span className="ct-hero-quick-label">Email Us</span>
                                    <span className="ct-hero-quick-value">info@edufolio.com</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="ct-contact-grid">
                        ...
                        <aside className="ct-sidebar">
                            ...
                            <div className="ct-callback-card">
                                ...
                                <a href="tel:+919876543210" className="ct-callback-btn">
                                    <i className="fa-solid fa-phone" aria-hidden="true"></i>
                                    Call Now
                                </a>
                            </div>
            ...
            <section className="ct-faq-section" aria-labelledby="faq-title">
                ...
                <div className="ct-container">
                    ...
                    <div className="ct-faq-cta">
                        ...
                        <a href="tel:+919876543210" className="ct-faq-cta-btn">
                            <i className="fa-solid fa-phone" aria-hidden="true"></i>
                            Talk to an Expert
                        </a>
                    </div>
                ...
                <div className="ct-container">
                    <div className="ct-cta-content">
                        ...
                        <div className="ct-cta-btns">
                            <Link to="/programs" className="ct-cta-btn ct-cta-btn-primary">
                                <i className="fa-solid fa-graduation-cap" aria-hidden="true"></i>
                                Explore Programs
                            </Link>
                            <Link to="/universities" className="ct-cta-btn ct-cta-btn-secondary">
