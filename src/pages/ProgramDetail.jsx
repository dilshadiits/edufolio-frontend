        ...
        return (
            <>
                ...
                <div className="pd-error-container" role="alert">
                    ...
                    <Link to="/programs" className="pd-back-button">
                ...
                <div className="pd-hero-content">
                    ...
                    <nav className="pd-breadcrumb" aria-label="Breadcrumb">
                        <ol className="pd-breadcrumb-list">
                            ...
                            <li className="pd-breadcrumb-item">
                                <Link to="/programs" className="pd-breadcrumb-link">Programs</Link>
                            </li>
                            <li className="pd-breadcrumb-separator" aria-hidden="true">/</li>
                    ...
                    <div className="pd-content-grid">
                        ...
                        <aside className="pd-right-sidebar">
                            ...
                            {university.name && (
                                <div className="pd-sidebar-card">
                                    ...
                                    <div className="pd-university-card">
                                        ...
                                        {university.slug && (
                                            <Link to={`/universities/${university.slug}`} className="pd-view-uni-btn">
                                                View University
                            ...
                            <div className="pd-help-card">
                                ...
                                <a href="tel:+919999999999" className="pd-help-button">
